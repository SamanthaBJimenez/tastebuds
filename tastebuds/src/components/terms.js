...
const Terms = ()=>{
    return(
        <>
        <h1>Here are the Terms</h1>

        <p>We and selected partners, use cookies or similar technologies as specified in the cookie policy.
        You can consent to the use of such technologies by closing this notice, by interacting with any link or button outside of this notice or by continuing to browse otherwise.</p>
        
        Welcome to Website Name!

These terms and conditions outline the rules and regulations for the use of TasteBuds Website, located at Website.com.
...
Cookies
We employ the use of cookies. By accessing Website Name, you agreed to use cookies in agreement with the TasteBuds Privacy Policy.
...
No use of TasteBuds logo or other artwork will be allowed for linking absent a trademark license agreement.
